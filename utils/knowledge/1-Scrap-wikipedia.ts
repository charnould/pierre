...
await $`rm -f ./knowledge/TABLE_OF_CONTENTS.md`;
await $`rm -f ./knowledge/CHUNKS_REPORT.md`;
...
console.log("👉 Outdated TABLE_OF_CONTENTS deleted");
console.log("👉 Outdated CHUNKS_REPORT deleted");
