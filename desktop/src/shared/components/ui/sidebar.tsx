...
import { CHROME_SHELL_FLOATING_SIDEBAR_CLASS } from '@/shared/lib/chrome-shell'
      ...
      >
        <div
          ...
          className={cn(
            ...
            'group-data-[variant=sidebar]:border-border group-data-[variant=sidebar]:border-r',
            CHROME_SHELL_FLOATING_SIDEBAR_CLASS
          )}
        >
          {children}
        </div>
