...
function DropdownMenuInput({ className, ...props }: React.ComponentProps<typeof Input>) {
  return (
    <div data-slot="dropdown-menu-input-wrapper" className="px-1.5 py-1">
      <Input data-slot="dropdown-menu-input" className={cn('h-8', className)} {...props} />
    </div>
  )
}

function DropdownMenuHint({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      data-slot="dropdown-menu-hint"
      className={cn('px-1.5 pb-1 text-xs leading-relaxed text-muted-foreground', className)}
      {...props}
    />
  )
}

function DropdownMenuStatus({
  className,
  ...props
}: React.ComponentProps<typeof DropdownMenuLabel>) {
  return (
    <DropdownMenuLabel
      data-slot="dropdown-menu-status"
