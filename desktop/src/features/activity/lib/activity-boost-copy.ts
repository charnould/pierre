...
const BOOST_NOUNS: Partial<Record<ActivityType, string>> = {
  ...
  repayment_phase_change: 'changement de groupe',
  repayment_assignment: 'affectation',
  repayment_tag_change: 'mise à jour des tags',
  action: 'action',
...
const BOOST_OBJECTS: Partial<Record<ActivityType, string>> = {
  ...
  repayment_phase_change: 'un changement de groupe',
  repayment_assignment: 'une affectation',
  repayment_tag_change: 'une mise à jour des tags',
  action: 'une tâche',
