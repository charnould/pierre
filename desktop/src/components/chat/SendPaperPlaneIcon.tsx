...
/** Icône d'envoi — même SVG que la version web (ChatApp). */
export function SendPaperPlaneIcon({ className }: { className?: string }) {
  return (
    <svg
      className={cn('pointer-events-none size-[26px] shrink-0', className)}
      viewBox="0 0 16 16"
      aria-hidden
    >
      <path
