  ...
  return html`<!doctype html>
    <html lang="fr" class="scroll-smooth bg-white tracking-[-0.1px] antialiased">
      <head>
        ...
        <link rel="stylesheet" href="../assets/core/dist/css/style.css" />
        <link
          rel="icon"
        ...
        <script type="module" src="../assets/core/dist/js/ai.js"></script>
        <title>Comment puis-je vous aider ? 🖐️</title>
      </head>

      <body class="mx-auto h-svh max-w-4xl">
        <script type="application/json" id="pierre-data">${raw(bootData)}</script>
        <div id="root"></div>
      </body>
    </html>`
}
