...
export const view = (metadata: Metadata[], events: KnowledgeBuildRow[]) => {
  return html`<!doctype html>
    <html lang="fr">
      <head>
        ...
        <link rel="stylesheet" href="../assets/dist/css/style.1779694004406.css" />
        <link
      ...
      <body class="mt-20 ml-20 w-4xl min-w-4xl bg-stone-50">
            ...
            >
              <p>
                ...
                <span class="block text-center font-mono text-[11px] text-white"
                  >Uniquement Excel/Word/Markdown</span
                >
              </p>
              ...
              <input
                ...
                id="files"
                name="files"
                accept=".doc, .docx, .xls, .xlsx, .xlsm, .xlsb, .md"
                hidden
                multiple
                required
              />
        ...
        <p class="mb-2 max-w-2xl text-sm">
          Uniquement les fichiers Word (<span class="rounded bg-neutral-200 px-1 font-mono"
            >.doc</span
          >/<span class="rounded bg-neutral-200 px-1 font-mono">.docx</span>), Excel (<span
            class="rounded bg-neutral-200 px-1 font-mono"
            >.xls</span
          >/<span class="rounded bg-neutral-200 px-1 font-mono">.xlsx</span>/<span
            class="rounded bg-neutral-200 px-1 font-mono"
            >.xlsm</span
          >/<span class="rounded bg-neutral-200 px-1 font-mono">.xlsb</span>) et Markdown (<span
            class="rounded bg-neutral-200 px-1 font-mono"
            >.md</span
          >) sont acceptés.
        </p>
        <p class="mb-2 max-w-2xl text-sm">
          ...
          <span class="rounded bg-neutral-200 px-1 font-mono">_metadata.xlsx</span>
          est obligatoire. Seuls les fichiers référencés dans celui-ci et disponibles ici sont pris
          en compte.
          <a
            href="../assets/files/_metadata.xlsx"
        ...
        <form method="post" enctype="multipart/form-data" class="mb-2 max-w-2xl text-sm">
          ...
          quelques secondes (variable selon le volume de données). Vous pouvez
          <button
        ...
        <h2 class="mb-6 text-2xl font-extrabold">
          Dernier rapport de construction de l'encyclopédie
        </h2>
