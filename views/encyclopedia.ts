  ...
  return html`<!doctype html>
    <html lang="fr">
      <head>
        ...
        <link rel="stylesheet" href="../assets/pierre-ia.org/dist/css/style.1735809447927.css" />
      ...
      <body class="mx-20 my-10 w-[800px]">
        ...
        <h1 class="mt-5 text-6xl font-bold">Encyclopédie</h1>
        <h2 class="mb-10 text-3xl font-medium">Très bientôt</h2>
      </body>
    </html>`
}
